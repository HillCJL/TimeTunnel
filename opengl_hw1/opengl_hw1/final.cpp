...
int main() {
    ...
    Shader PhongShader("final_phong.vs", "final_phong.fs");
    Shader ParticleShader("final_particle_gaussian.vs", "final_particle.fs");
    Shader ParticleHDRShader("final_particle.vs", "final_particle_hdr.fs");
